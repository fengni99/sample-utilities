...
import com.discovery.darchrow.http.BrowserUtil;
import com.discovery.darchrow.http.RequestUtil;
...
public class Browser implements Serializable{
	...
	/** 是不是 在微信中访问. */
	private boolean             isWechatBrowser;
	...
	public Browser(HttpServletRequest request){
		...
		this.isWindowsPhone = StringUtil.isContainIgnoreCase(userAgent, "Windows Phone");
		this.isWechatBrowser = StringUtil.isContainIgnoreCase(userAgent, "MicroMessenger");
	 ...
	 */
	public boolean getIsWechatBrowser(){
		return isWechatBrowser;
	}
